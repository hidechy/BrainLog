...
@section('content')
	                            ...
	                            <td>
	                                ...
	                                if (!isset($data2[$i][sprintf("%02d" , $j)])){
	                                    ...
	                                    if (isset($data[$i][sprintf("%02d" , $j)])){
	                                        foreach ($data[$i][sprintf("%02d" , $j)] as $v){echo "<div>" . $v . "</div>";}
	                                    }
	                                }
	                                ?>
	                            </td>
    ...
    <style type="text/css">
    <!--
    .tbl_money_credit_month td {border : 1px solid #cccccc; width : 180px; vertical-align : top; }
    #btn_money_list {cursor : pointer; margin : 2px; }
    .highlight {background-color : yellow; }
    #btn_money_credit {cursor : pointer; margin : 2px; }
    #div_credit_input {border : 1px solid #cccccc; background : #ccffcc; margin : 10px; }
    #div_credit_open {background : #339933; color : #ffffff; padding : 5px;}
    #ta_credit {width : 800px; height : 200px; }
    #span_credit_open {cursor : pointer; }
    -->
    </style>
